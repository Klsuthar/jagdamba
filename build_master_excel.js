...
for (let classNum = 1; classNum <= 5; classNum++) {
  ...
  if (!students || !Array.isArray(students) || students.length === 0) {
    // Default sample list if empty
    students = [
      { roll_no: 1, student_name: 'STUDENT ONE', father_name: 'FATHER NAME', mother_name: 'MOTHER NAME', dob: '01-01-2018', image: `class_${classNum}/01_class${classNum}.webp` }
    ];
  }
  ...
  const sheetData = students.map(student => {
    ...
    return {
      ...
      // Test 1 Marks (empty until real data entered)
      ...
      // Test 2 Marks (empty until real data entered)
      ...
      // Half Yearly Marks (empty until real data entered)
      ...
      // Test 3 Marks (empty until real data entered)
      ...
      // Yearly Marks (empty until real data entered)
...
console.log('Master Excel File generated successfully at:');
console.log(' -', PUBLIC_EXCEL_PATH);
console.log(' -', ROOT_EXCEL_PATH);
